...
## Software Developer Tools and Tutorials

1. [Linux](https://linuxsurvival.com/linux-tutorial-introduction/)
1. [git](https://learngitbranching.js.org)
1. [Docker](https://www.docker.com/101-tutorial/) / [Compose](https://docs.docker.com/compose/gettingstarted/)
1. [ROS2](https://docs.ros.org/en/jazzy/Tutorials.html)
1. [MoveIt2](https://moveit.picknik.ai/main/doc/tutorials/tutorials.html)
